...
repo init -u https://github.com/DerpFest-AOSP/manifest -b 15.2 --git-lfs; \
/opt/crave/resync.sh; \
...
git clone https://gitlab.com/rik-x777/kernel_xiaomi_sm8250 -b nxt-a16 kernel/xiaomi/sm8250; \
