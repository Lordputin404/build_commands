...
git clone https://github.com/Lordputin404/android_device_xiaomi_munch -b clover device/xiaomi/munch; \
...
git clone https://github.com/EmanuelCN/kernel_xiaomi_sm8250 -b bpf2 kernel/xiaomi/munch; \
