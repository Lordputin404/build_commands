...
repo init -u https://github.com/CipherOS/android_manifest -b sixteen --git-lfs; \
...
git clone https://github.com/Lordputin404/android_device_xiaomi_munch_hdzungx -b cipher device/xiaomi/munch; \
...
lunch cipher_munch-bp2a-userdebug
mka bacon
